 ...
 */
// Marche aussi mais pas pour les tests
products = [
   { name: 'iPhone X', price: 1159 },
   { name: 'Xiaomi Mi A2', price: 209 },
   { name: 'Samsung Galaxy Note 9', price: 992 },
...
// const maxPrice = 500
// function filterOnPrice(item) {
//     return item.price<maxPrice;
// } 
// const cheapProducts =  products.filter(filterOnPrice)
// console.log(cheapProducts)


// Pour les tests:
// function filterOnPrice(array) {
//   return array.filter(price => price < 500)
// }
let priceMax = 400
function filterOnPrice(array, priceMax) {
  return array.filter((item) => {
    return item.price <= priceMax;
  });
}
console.log(filterOnPrice(products, priceMax))
// console.log(cheapProducts)
